...
class SanctuarySceneEngine {
    ...
    private fun anchorFor(species: WildlifeHabitatAffinity, index: Int, seed: Int): HabitatAnchor {
        val base = when (species.badgeId) {
            ...
            "badge_sinarapan" -> HabitatAnchor(.23f, .76f, .14f, 4f, .78f)
            "badge_peacock_pheasant" -> HabitatAnchor(.34f, .72f, .18f, 5f, .74f)
            "badge_cebu_flowerpecker" -> HabitatAnchor(.43f, .29f, .12f, 2f, .24f)
            "badge_spotted_deer" -> HabitatAnchor(.68f, .66f, .24f, 5f, .69f)
            "badge_pangolin" -> HabitatAnchor(.54f, .73f, .16f, 5f, .76f)
            "badge_flying_fox" -> HabitatAnchor(.83f, .31f, .17f, 2f, .27f)
            else -> HabitatAnchor(.18f, .70f, .24f, 4f, .73f)
        }
